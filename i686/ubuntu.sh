...
if [[ $preference == "A" ]]; then
  ...
  curl -sL https://github.com/adobe/brackets/releases/download/release-$pkgver/Brackets.Release.$pkgver.32-bit.deb > /tmp/brackets-i386.deb
  # install from deb
  ...
  curl -sL http://security.ubuntu.com/ubuntu/pool/main/libg/libgcrypt11/libgcrypt11_1.5.3-2ubuntu4.3_i386.deb > $HOME/Programs/libgcrypt11_1.5.3-2ubuntu4.3_i386.deb
